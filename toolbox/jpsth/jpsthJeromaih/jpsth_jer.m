...
function [jpsthData] = jpsth_jer(n_1, n_2, coinWidth)
	...
	[covariogram,sigHigh,sigLow,parts] = covariogramBrody(n_1,n_2,psth_1,psth_2,psth_1_var,psth_2_var);
	...
	jpsthData = struct('psth_1',psth_1,'psth_2',psth_2, ...
                        'psth_1_sd',psth_1_sd,'psth_2_sd',psth_2_sd, ...
						'normalizedJPSTH',normalizedJPSTH, ...
                        'rawJpsth',rawJPSTH',...
                        'psthOuterProduct', psthOuterProduct,... 
                        'unnormalizedJPSTH', unnormalizedJPSTH,... 
                        'normalizer',normalizer,...
						'xcorrHist',xcorrHist, ...
						'coincidenceHist',pstch, ...
                        'brodyParts', parts,...
