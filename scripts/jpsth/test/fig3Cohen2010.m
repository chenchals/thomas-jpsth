...
vis = load('~/Projects/NEIWork/SATCorrelations/Fig3Data/fecfef_m260.mat','-mat');
...
jer = SpikeUtils.jeromiahJpsth(vXAligned,vYAligned,vTimeWin,binWidth,10);

jpsth = SpikeUtils.jpsth(vXAligned,vYAligned,vTimeWin,binWidth,10);
